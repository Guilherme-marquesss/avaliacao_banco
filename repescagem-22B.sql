...
SELECT nome, data_contratacao FROM Medicos ORDER BY data_contratacao DESC;

SELECT * FROM Medicos WHERE especializacoes_adicionais = 'Cirurgia';

SELECT * FROM Medicos ORDER BY nome ASC, email ASC;

SELECT * FROM Medicos WHERE horario_trabalho = '12:00-20:00' or '11:00-19:00'; 

SELECT * FROM Medicos WHERE telefone = '8901';

SELECT * FROM Medicos WHERE salario = '15000' and '16000';
